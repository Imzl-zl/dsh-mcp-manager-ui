...
export const BUILTIN_MCP_SERVERS = [
  {
    id: 'exa',
    label: 'Exa',
    summary: '网页搜索、代码搜索与页面内容读取',
    access: '免密限额；可添加 API Key 提升额度',
    name: 'exa',
  ...
  },
  {
    id: 'tavily',
    label: 'Tavily',
    summary: '面向 Agent 的网页搜索与内容提取',
    access: '免密限额（Search / Extract）；可切换免费账号 API Key',
    name: 'tavily',
    transport: 'streamable-http',
  ...
  },
  {
    id: 'firecrawl',
    label: 'Firecrawl',
    summary: '网页搜索、抓取与文档解析',
    access: '免密限额（Search / Scrape / Parse）；可添加 API Key',
    name: 'firecrawl',
    transport: 'streamable-http',
  ...
  },
  {
    ...
    summary: '浏览器调试、网络检查与性能分析',
    access: '本地 npx；需要 Node.js 与 Chrome',
  ...
  },
  {
    id: 'playwright',
    label: 'Playwright',
    summary: '基于可访问性快照的浏览器自动化',
    access: '本地 npx；需要 Node.js 20+',
    name: 'playwright',
    transport: 'stdio',
    command: 'npx',
...
const BUILTIN_MCP_IDENTITIES = {
  exa: { hosts: ['mcp.exa.ai'], packages: ['exa-mcp-server'] },
  tavily: { hosts: ['mcp.tavily.com'], packages: ['tavily-mcp'] },
  firecrawl: { hosts: ['mcp.firecrawl.dev'], packages: ['firecrawl-mcp'] },
  'chrome-devtools': { packages: ['chrome-devtools-mcp'] },
  playwright: { packages: ['@playwright/mcp'] },
}
